...
**画面に常にあるもの**：瓶、部屋、下端の小さな点3つ（今どの瓶か）、隅の小さなアイコン2つ（餌・日誌）。それ以外は出さない。夜の間だけ、画面下に照明のオン・オフの小さなアイコンを出す（昼・夕方は出さない）。
...
- 夜：窓光はほぼゼロ。画面外、瓶の左上（窓と同じ側）にあるクランプ式のアーム型デスクライトが主光源になる（ライト本体は映さない）。ヘッドが小さく光は狭い円錐で、左上から斜めに、瓶の開いた口と窓側のガラスから水中へ入る。天板には瓶を中心にやや右へずれた楕円の光だまりができ、輪郭はある程度はっきり切れて、その外は闇。瓶の影は昼と同じく右側へ落ちる。光の色はわずかに暖かい白。瓶のガラスへの光の回り込みとマリンスノーの見え方は、この照明を光源にする（照明の円錐の中だけが見える）
...
3. **育つ瓶**：生活環（ポリプ・ストロビラ・エフィラ）、3瓶スワイプ、個体の移動、餌、観察日誌
   - **瓶を揺らす**（操作の詳細は未定）：傘は慣性で動き、触手は水と一緒に動く。瓶を急に下げたり、揺らして海月が転がったりしたときは、傘だけが先に動き、触手は水に取り残されて傘の上までふわっと舞い上がり広がる。そのあと数秒かけてゆっくり垂れ戻る。これが揺らしの一番の見どころなので、触手の水への追従を傘より強くしておく
