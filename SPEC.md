...
- 追加の順：
  - 第1弾：Neoturris sp.（傘高約3cm、傘の縁・内部・触手が朱色）、Eirene menoni（傘径約2cm、お椀型の透明な傘、縁に真珠のような粒）、オワンクラゲ（お椀型の透明な傘。つついたときだけ傘の縁に並んだ粒が青緑に光る。照明オフのときに一番よく見える）
  - 第2弾：カブトクラゲ（拍動せず、櫛板を虹色の光が流れる。虹は反射なので照明か窓の光がないと見えない）
  - 最後・余力があれば：目玉焼きクラゲ、Rhizostoma pulmo（瓶の中では若い姿のまま大きくならない。ごくまれ）
